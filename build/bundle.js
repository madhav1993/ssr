...
var fetchAdminss = exports.fetchAdminss = function fetchAdminss() {
    return function () {
...
exports.default = {
    component: (0, _reactRedux.connect)(mapStateToProps, { fetchAdminss: _actions.fetchAdminss })((0, _requireAuth2.default)(AdminsList)),
    loadData: function loadData(_ref2) {
        var dispatch = _ref2.dispatch;
        return dispatch((0, _actions.fetchAdminss)());
    }
};
